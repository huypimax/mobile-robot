...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.tf_listen_ = TransformListener(self.tf_buffer_, self)

        self.static_transform_stamped_.header.stamp = self.get_clock().now().to_msg()
        self.static_transform_stamped_.header.frame_id = "bumperbot_top"
        self.static_transform_stamped_.child_frame_id = "bumperbot_base"
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "bumperbot_top"
    ...
    def getTransformCallback(self, req, res):
        self.get_logger().info("Request Transform between %s and %s" % (req.frame_id, req.child_frame_id))
