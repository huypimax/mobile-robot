...
class SimpleController(Node):
    def __init__(self):
        ...
        self.wheel_separation_ = self.get_parameter("wheel_separation").get_parameter_value().double_array_value
    ...
    def jointCallback(self, msg):
        ...
        d_s = (self.wheel_radius_ * dp_right + self.self.wheel_radius_ * dp_left) / 2
        ...
        self.odom_msg_.pose.pose.position.x = self.y_
